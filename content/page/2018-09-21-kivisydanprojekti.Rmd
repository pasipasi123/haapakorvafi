...
Heinäkuussa 2017 käynnistin vuokraamallani serverillä ohjelman, joka puolen tunnin välein kysyy rajapinnalta Kivisydämen ja kaikkien muiden pysäköintitalojen tiedot. Tietoa on nyt kertynyt katkotta jo yli vuoden. Projektin toinen osa on ollut kehittää twitterbotti twiittaamaan säännöllisesti tietoja datasta. Botti twiittaa joka päivä edellisen [päivän käyttötiedon viivakuviona](https://twitter.com/kivisydanbot/media). Maanantaisin nähdään koko edellinen viikko. Muutoin botti twiittaa noin tasatunnein reaaliaikaisin käyttötiedon.
