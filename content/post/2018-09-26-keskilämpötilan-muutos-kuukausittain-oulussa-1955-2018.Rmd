...
Päivämäärät on muutettava `character`-tyyppisiksi, koska `pmap` kärsii R:n [bugista](https://github.com/tidyverse/purrr/issues/358#issuecomment-363091446), joka jonka vuoksi `date`-tyypin vektoria ei voi käyttää, mutta luotaviin queryosoitteisiin muunnoksella ei ole vaikutusta.
